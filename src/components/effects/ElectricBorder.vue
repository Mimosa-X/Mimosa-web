...
// 生成唯一ID
const rawId = `id-${Math.random().toString(36).substring(2, 15)}`;
...
<template>
  <div ref="rootRef" :class="['electric-border-wrapper', className]" :style="style">
    <svg
      ref="svgRef"
    ...
    <div class="electric-border-glow-container" :style="inheritRadius">
      <div ref="strokeRef" class="electric-border-stroke" :style="strokeStyle" />
      <div class="electric-border-glow1" :style="glow1Style" />
      <div class="electric-border-glow2" :style="glow2Style" />
...
.electric-border-stroke,
.electric-border-glow1,
.electric-border-glow2,
